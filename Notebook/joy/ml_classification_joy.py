...
train_filename = 'training/EI-oc-En-joy-train.txt'
dev_filename = 'development/2018-EI-oc-En-joy-dev.txt'
test_filename = 'test-gold/2018-EI-oc-En-joy-test-gold.txt'
...
e_word = "joy"
intensity_mapping = generate_intensity_mapping("joy")
