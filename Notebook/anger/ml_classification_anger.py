...
train_filename = 'training/EI-oc-En-anger-train.txt'
dev_filename = 'development/2018-EI-oc-En-anger-dev.txt'
test_filename = 'test-gold/2018-EI-oc-En-anger-test-gold.txt'
...
e_word = "anger"
intensity_mapping = generate_intensity_mapping("anger")
