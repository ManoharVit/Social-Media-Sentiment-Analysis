...
train_filename = 'training/EI-oc-En-sadness-train.txt'
dev_filename = 'development/2018-EI-oc-En-sadness-dev.txt'
test_filename = 'test-gold/2018-EI-oc-En-sadness-test-gold.txt'
...
e_word = "sadness"
intensity_mapping = generate_intensity_mapping("sadness")
